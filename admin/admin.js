...
let allImages = [
        'Acropolis Collection.png',
        'Ancient Statue Study.png',
        'Arch.png',
        'Aunt Lisa.png',
        'Baltimore Lighthouse.png',
        'Beach Ladies.png',
        'Blue Mosque.png',
        'Booba.png',
        'Boy Golden.png',
        ...
        'Crab.png',
        'Cycladic Lady.png',
        'Desert Rock Formations.png',
        'Hooper Strait.png',
        'IAD ATH.png',
        'Istanbul Fountain & Skyline.png',
        'Istanbul Spice Market.png',
        'Little Magothy.png',
        'Marjan Forest Park, Split.png',
        'Marker Inventory.png',
        'Mudd.png',
        'O Thanasis.png',
        'Ryan Tattoo.png',
        'Samria-Sunrise.png',
        'SHitns.png',
        'Split to Istanbul.png',
        'STB.png',
        'Sultan Ahmed Mosque.png',
        'Travel Sketch XII.png',
        'Travel Sketch XIII.png',
        'Travel Sketch XIV.png',
        'Turkish Stamp Collection.png',
        'Yellow Boat.png'
    ];
let unplacedImages = [];
let currentIndex = 0;
